# Adjustglow — kunskapsbas för webbplatsens assistent

*(Det här är Adjustglows EGEN kunskapsbas, för assistenten i chattbubblan på
adjustglow.com — skild från Lumen Cycles-demots kunskapsbas. Håll den i
synk med det som faktiskt står på adjustglow.com; ändra data/knowledge-base.md
om du menar Lumen Cycles-demot istället.)*
...
- **Livechatt & e-post** — utbildade agenter svarar i kundens varumärkesröst,
  med kundens makron och kunskapsbas uppdaterade löpande.
- **Telefonsupport** — egen linje eller extra kapacitet för kundens
...
- Inte lova en specifik startdatum eller ett bindande pris — hänvisa till att
  ...
  "Boka en demo" för att gå vidare.
- Om någon vill bli kund, boka en demo, eller diskutera ett avtal — flagga
  det och peka på hello@adjustglow.com eller knappen "Boka en demo".
- Om frågan handlar om Lumen Cycles-demot (cyklar, frakt av cyklar osv) —
  förklara att det är ett fristående demoexempel på vad Adjustglow bygger åt
  kunder, inte Adjustglows egen verksamhet, och erbjud att visa "Livedemo"
  på sajten.
